...
rxns_df_input_filepath = "../data/raw/enzymemap_MetaCyc_processed.csv"
rxns_df_output_filepath = "../data/interim/enzymemap_MetaCyc_JN_mapped.parquet"
...
enzymatic_rxns_df = pd.read_csv(rxns_df_input_filepath).iloc[0:10,:]
